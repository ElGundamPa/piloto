...
export default function CotizarPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      {/* Hero section - Tono cálido para conversión */}
      <section className="pt-24 pb-16 bg-gradient-to-br from-primary-600 via-primary-500 to-primary-400 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-5 right-1/4 w-48 h-48 rounded-full bg-white/20 blur-3xl" />
          <div className="absolute bottom-5 left-1/3 w-64 h-64 rounded-full bg-white/10 blur-3xl" />
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.nombre ? 'border-red-500' : 'border-gray-300'
                      }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.correo ? 'border-red-500' : 'border-gray-300'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${errors.telefono ? 'border-red-500' : 'border-gray-300'
                        }`}
